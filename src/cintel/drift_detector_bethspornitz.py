...
Terminal command to run this file from the root project folder
    ...
    uv run python -m cintel.drift_detector_bethspornitz
...
REFERENCE_FILE: Final[Path] = DATA_DIR / "reference_metrics_bethspornitz.csv"
CURRENT_FILE: Final[Path] = DATA_DIR / "current_metrics_bethspornitz.csv"

OUTPUT_FILE: Final[Path] = ARTIFACTS_DIR / "drift_summary_bethspornitz.csv"
SUMMARY_LONG_FILE: Final[Path] = ARTIFACTS_DIR / "drift_summary_long_bethspornitz.csv"
...
ERRORS_DRIFT_THRESHOLD: Final[float] = 1.0
LATENCY_DRIFT_THRESHOLD: Final[float] = 500.0
